...
{
    public class Modulo750 : BaseController
    {
        ...
        internal static List<ModelRenderElement> setdListElement(string Tape_180o90, string Tape_0o270, long EndWallX, long EndWallY, long LongLeft, long LongRight, bool IsFirstModule, bool IsDimActive, long type, DAL.TSql_DefaultDesign currentDefaultDisign, long DataHeight, long dataWith, long datalong, long dataCordenadX, long dataCordenadY, RotateMesh meshRotateX, RotateMesh meshRotateMirrowX, string dataRotateZ, long _Type, bool _isEndModule, bool _HasPreviousModule, long _DataSupEnd)
        {
            ...
            if (_DataSupEnd == 0)
            {
                if (_isEndModule == true)
                {
                    if (type == 1)
                    {
                        dataCordenadX = EndWallX - 75;
                    }
                    if (type == 2)
                    {
                        dataCordenadY = EndWallY - 75;
                    }
                }
            }
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    if (_isEndModule != true)
                    {
                        ...
                        CommonElement.SedDiwydagD(type, PanelPerfil, 75, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
                        CommonElement.SedDiwydagD(type, PanelPerfil, 75, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                    }
                    else
                    {
                        CommonElement.SedDiwydagD(type, PanelPerfil, 35, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
                        CommonElement.SedDiwydagD(type, PanelPerfil, 35, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                        //CommonElement.SedDiwydagD(type, PanelPerfil, 65, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
                        //CommonElement.SedDiwydagD(type, PanelPerfil, 65, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                    }
                    if (i == 0)
                    {
                    ...
                    else
                    {
                        ...
                        CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 20, dataCordenadY, Elevation - 30, ListRenderElement, dataWith / 10, "");
                        CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 20, dataCordenadY, Elevation - 30, ListRenderElement, dataWith / 10, "");
                        ...
                        CommonElement.SedUnionHorizontal(type, PanelPerfil, 0, dataCordenadX, 62, dataCordenadY, nHeight, ListRenderElement, "90");
                        CommonElement.SedUnionHorizontalMirror(type, PanelPerfil, 0, dataCordenadX, 62, dataCordenadY, nHeight, ListRenderElement, dataWith / 10, "90");
                    }
                    ...
                    if (_HasConer0 != true)
                    {
                        CommonElement.SedDiwydagD(type, PanelPerfil, 0, dataCordenadX + 65, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
                        CommonElement.SedDiwydagD(type, PanelPerfil, 0, dataCordenadX + 65, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                    }
                    else
                    {
                    ...
                    CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 300, type, 45, DimType.Horizontal, type.ToString(), "", 0);
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    elements22.Element = Atk60Element.GetElement("Panel30270");
                    elements22.ElementF = Atk60Element.GetElement("Panel30270F");
                    elements22.CodeName = "27304205";
                    elements22.z = elements22.z + nHeight;
                    elements22.x = dataCordenadX + 75;
        ...
        private static void Insert2700Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule, bool _HasPreviousModule)
        {
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 20, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 20, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.SedUnionHorizontal(type, PanelPerfil, 0, dataCordenadX, 10, dataCordenadY, nHeight, ListRenderElement, "90");
                CommonElement.SedUnionHorizontalMirror(type, PanelPerfil, 0, dataCordenadX, 10, dataCordenadY, nHeight, ListRenderElement, dataWith / 10, "90");
            ...
            element1.Element = Atk60Element.GetElement("Panel30270");
            element1.ElementF = Atk60Element.GetElement("Panel30270F");
            element1.CodeName = "27304205";
            ...
            element44.Element = Atk60Element.GetElement("Panel30270");
            element44.ElementF = Atk60Element.GetElement("Panel30270F");
            element44.CodeName = "27304205";
            element44.z = element44.z + nHeight;
            element44.x = dataCordenadX + 75;
        ...
        private static void Insert1200Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule, bool _HasPreviousModule)
        {
            ...
            if (_isEndModule != true)
            {
                ...
                CommonElement.SedDiwydagD(type, PanelPerfil, 75, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 115, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 75, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 35, false);
            }
            else
            {
                CommonElement.SedDiwydagD(type, PanelPerfil, 45, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 115, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 45, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 35, false);
                //CommonElement.SedDiwydagD(type, PanelPerfil, 65, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 115, false);
                //CommonElement.SedDiwydagD(type, PanelPerfil, 65, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 35, false);
            }
            if (_HasPreviousModule != true)
            {
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.SedUnionHorizontal(type, PanelPerfil, 0, dataCordenadX, 60, dataCordenadY, nHeight + SupNHeight, ListRenderElement, "90");
                CommonElement.SedUnionHorizontalMirror(type, PanelPerfil, 0, dataCordenadX, 60, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "90");
            }
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 450, type, 0, DimType.Horizontal, type.ToString(), "", 0);
            ModelRenderElement element = new ModelRenderElement();
            ...
            element11.Element = Atk60Element.GetElement("Panel30120");
            element11.ElementF = Atk60Element.GetElement("Panel30120F");
            element11.CodeName = "12304211";
            ...
            ModelRenderElement element44 = new ModelRenderElement();
            element44.Element = Atk60Element.GetElement("Panel30120");
            element44.ElementF = Atk60Element.GetElement("Panel30120F");
            element44.CodeName = "12304211";
            element44.z = element44.z + nHeight;
            element44.x = dataCordenadX + 75;
            element44.y = (dataCordenadY - dataWith / 10);
            element44.XRotate = 180;
        ...
        private static void Insert2400Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule, bool _HasPreviousModule)
        {
            ...
            if (_isEndModule != true)
            {
                CommonElement.SedDiwydagD(type, PanelPerfil, 35, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 185, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 35, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 75, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 185, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 75, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
            }
            else
            {
                ...
                CommonElement.SedDiwydagD(type, PanelPerfil, 45, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                //CommonElement.SedDiwydagD(type, PanelPerfil, 65, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 185, false);
                //CommonElement.SedDiwydagD(type, PanelPerfil, 65, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
            }
            if (_HasPreviousModule != true)
            {
            ...
            ModelRenderElement element11 = new ModelRenderElement();
            element11.Element = Atk60Element.GetElement("Panel30240");
            element11.ElementF = Atk60Element.GetElement("Panel30240F");
            element11.CodeName = "24304244";
            element11.z = element11.z + nHeight;
            element11.x = dataCordenadX + 45;
            element11.y = dataCordenadY;
            element11.XRotate = 0;
            ...
            ModelRenderElement element44 = new ModelRenderElement();
            element44.Element = Atk60Element.GetElement("Panel30240");
            element44.ElementF = Atk60Element.GetElement("Panel30240F");
            element44.CodeName = "24304244";
            element44.z = element44.z + nHeight;
            element44.x = dataCordenadX + 75;
            element44.y = (dataCordenadY - dataWith / 10);
            element44.XRotate = 180;
