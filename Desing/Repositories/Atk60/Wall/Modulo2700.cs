...
{
    public class Modulo2700 : BaseController
    {
        ...
        private static void SedPanels(bool IsFirstModule, bool _isDimActive, long type, DAL.TSql_DefaultDesign currentDefaultDisign, long DataHeight, long datalong, long dataCordenadX, long dataCordenadY, long dataWith, List<ModelRenderElement> ListRenderElement, long _Type, bool _isEndModule, bool _HasPreviousModule)
        {
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    if (_isEndModule == true)
                    {
                        CommonElement.SedDiwydagD(type, PanelPerfil, 260, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
                        CommonElement.SedDiwydagD(type, PanelPerfil, 260, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                    }
                    else
                    {
                        CommonElement.SedDiwydagD(type, PanelPerfil, 270, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
                        CommonElement.SedDiwydagD(type, PanelPerfil, 270, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 270, dataCordenadY, nHeight + 45, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 270, dataCordenadY, nHeight + 135, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 270, dataCordenadY, nHeight + 225, ListRenderElement, "");
                        CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 270, dataCordenadY, nHeight + 45, ListRenderElement, dataWith / 10, "");
                        CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 270, dataCordenadY, nHeight + 135, ListRenderElement, dataWith / 10, "");
                        CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 270, dataCordenadY, nHeight + 225, ListRenderElement, dataWith / 10, "");
                    }
                    //Horisontal
                    if (i == 0)
                    {
                    ...
                    else
                    {
                        ...
                        CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 240, dataCordenadY, Elevation - 30, ListRenderElement, dataWith / 10, "");
                    ...
                    CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 900, type, 180, DimType.Horizontal, type.ToString(), "", 0);
                    ModelRenderElement element3 = new ModelRenderElement();
                    element3.Element = Atk60Element.GetElement("Panel90270");
                    element3.ElementF = Atk60Element.GetElement("Panel90270F");
                    element3.CodeName = "27904209";
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    elements3.Element = Atk60Element.GetElement("Panel90270");
                    elements3.ElementF = Atk60Element.GetElement("Panel90270F");
                    elements3.CodeName = "27904209";
                    elements3.z = elements3.z + nHeight;
                    elements3.x = dataCordenadX + 270;
        ...
        private static void Insert900ElementT(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong)
        {
            ...
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 2700, type, 0, DimType.HorizontalT, type.ToString(), "", 0);
            ModelRenderElement element = new ModelRenderElement();
        ...
        private static void Insert1200Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule)
        {
            ...
            CommonElement.SedDiwydagD(type, PanelPerfil, 180, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 35, false);
            CommonElement.SedDiwydagD(type, PanelPerfil, 180, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 115, false);
            ...
            if (IsEndModule != true)
            {
                ...
                CommonElement.SedDiwydagD(type, PanelPerfil, 270, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 35, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 270, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 115, false);
            }
            else
            {
                CommonElement.SedDiwydagD(type, PanelPerfil, 260, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 35, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 260, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 115, false);
            }
            if (nHeight != 0)
            {
            ...
            if (IsRiji == 2)
            {
                ...
                CommonElement.UnionRiji(2, type, PanelPerfil, 0, dataCordenadX, 240, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                ...
                CommonElement.UnionRijiMirror(2, type, PanelPerfil, 0, dataCordenadX, 240, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
            }
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 900, type, 0, DimType.Horizontal, type.ToString(), "", 0);
            ModelRenderElement element = new ModelRenderElement();
            ...
            if (type == 1)
            {
                CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX + 90, dataCordenadY, 900, type, 90, DimType.Horizontal, type.ToString(), "", 0);
            }
            else
            {
                CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY + 90, 900, type, 90, DimType.Horizontal, type.ToString(), "", 0);
            }
            ModelRenderElement element3 = new ModelRenderElement();
        ...
        private static void Insert2400Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule)
        {
            ...
            else
            {
                if (IsEndModule != true)
                {
                    ...
                    CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 270, dataCordenadY, nHeight + 40, ListRenderElement, "");
                    CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 270, dataCordenadY, nHeight + 200, ListRenderElement, "");
                }
                else
                {
                    CommonElement.SedDiwydagD(type, PanelPerfil, 0, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
            ...
            //CommonElement.InsertUnionElement270(ListRenderElement, dataCordenadX, dataCordenadY, nHeight, dataWith, type, _isEndModule, HasPreviousModule, 15, 160);
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 900, type, 0, DimType.Horizontal, type.ToString(), "", 0);
            ModelRenderElement element = new ModelRenderElement();
            ...
            ModelRenderElement element3 = new ModelRenderElement();
            element3.Element = Atk60Element.GetElement("Panel90240");
            element3.ElementF = Atk60Element.GetElement("Panel90240F");
            element3.CodeName = "24904240";
            element3.z = element3.z + nHeight;
            element3.x = dataCordenadX + 180;
            element3.y = dataCordenadY;
            element3.XRotate = 0;
            ...
            ListRenderElement.Add(element5);
            ModelRenderElement element6 = new ModelRenderElement();
            element6.Element = Atk60Element.GetElement("Panel90240");
            element6.ElementF = Atk60Element.GetElement("Panel90240F");
            element6.CodeName = "24904240";
            element6.z = element6.z + nHeight;
            element6.x = dataCordenadX + 270;
            element6.y = (dataCordenadY - dataWith / 10);
            element6.XRotate = 180;
        ...
        private static void InsertUnionElement120270(List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long NexHeight)
        {
            if (nHeight != 0)
            {
                CommonElement.SedUnionHorizontal(type, PanelPerfil, 0, dataCordenadX, 20, dataCordenadY, nHeight, ListRenderElement, "90");
