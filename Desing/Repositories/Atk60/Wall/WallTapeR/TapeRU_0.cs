...
{
    public class TapeRU_0 : BaseController
    {
        internal static List<ModelRenderElement> setdListElement(long EndWallX, long DataHeight, long dataWith, long datalong, long dataCordenadY, long TypeH, bool IsCorner)
        {
            ...
            {
                case 270:
                    SedUnion270(EndWallX, DataHeight, datalong, dataCordenadY, dataWith, ListRenderElement, IsCorner);
                    break;
                case 240:
                    SedUnion240(EndWallX, DataHeight, datalong, dataCordenadY, dataWith, ListRenderElement, IsCorner);
                    break;
                case 120:
                    SedUnion120(EndWallX, DataHeight, datalong, dataCordenadY, dataWith, ListRenderElement, IsCorner);
                    break;
            }
        ...
        private static void SedUnion270(long endWallX, long nHeight, long datalong, long dataCordenadY, long dataWith, List<ModelRenderElement> listRenderElement, bool IsCorner)
        {
            ...
            //    {
            //        dataCordenadY = dataCordenadY + 30;
            //    }
            //}
