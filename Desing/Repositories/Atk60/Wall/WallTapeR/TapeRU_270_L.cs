...
{
    public class TapeRU_270_L : BaseController
    {
        ...
        private static void SedUnion270(long endWallX, long nHeight, long datalong, long dataCordenadY, long dataWith, List<ModelRenderElement> listRenderElement)
        {
            ...
            elementGancho180.x = endWallX - 4;
            elementGancho180.y = dataCordenadY /*- ((dataWith / 10) - 75)*/ + 1;
            elementGancho180.z = elementGancho180.z + nHeight + 55;
            elementGancho180.XRotate = 180;
            ...
            elementTuercaFija180.y = dataCordenadY + 12;
            elementTuercaFija180.z = elementTuercaFija180.z + nHeight + 55;
            elementTuercaFija180.XRotate = 271;
            ...
            elementGancho2180.x = endWallX - 4;
            elementGancho2180.y = dataCordenadY /*- ((dataWith / 10) - 75) */+ 1;
            elementGancho2180.z = elementGancho2180.z + nHeight + 135;
            elementGancho2180.XRotate = 180;
            ...
            elementTuercaFija2180.y = dataCordenadY + 12;
            elementTuercaFija2180.z = elementTuercaFija2180.z + nHeight + 135;
            elementTuercaFija2180.XRotate = 271;
            ...
            elementTuercaFija4180.x = endWallX - 4;
            elementTuercaFija4180.y = dataCordenadY /*- ((dataWith / 10) - 75)*/ + 1;
            elementTuercaFija4180.z = elementTuercaFija4180.z + nHeight + 215;
            elementTuercaFija4180.XRotate = 180;
            ...
            elementTuercaFija3180.y = dataCordenadY + 12;
            elementTuercaFija3180.z = elementTuercaFija3180.z + nHeight + 215;
            elementTuercaFija3180.XRotate = 271;
