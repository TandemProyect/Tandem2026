...
{
    public class ModuloTape_180 : BaseController
    {
            ...
            if (restHeight > 0)
            {
                ...
                if (RestTypeHeight == 2400)
                {
                    if (currentDefaultDisign.ExitingPanel2400 == true)
                    {
                        ...
                        Insert30_2400Element(Elevation, DimTypeH, CHeck750R, endWallX, IsRiji, true, dimTypeVertical, currentDefaultDisign, ListRenderElement, dataCordenadX, dataCordenadY, nHeight, dataWith, datalong);
                        LastPanel = 2400;
                    }
                    else
                    {
                        Insert30_1200Element(Elevation, DimTypeH, CHeck750R, endWallX, 1, true, dimTypeVertical, currentDefaultDisign, ListRenderElement, dataCordenadX, dataCordenadY, nHeight, dataWith, datalong);
                        nHeight = nHeight + 120;
                        var IsRiji = 0;
                        if (Is2700 == true)
                        {
                        ...
                        Insert30_1200Element(Elevation, DimTypeH, CHeck750R, endWallX, IsRiji, true, dimTypeVertical, currentDefaultDisign, ListRenderElement, dataCordenadX, dataCordenadY, nHeight, dataWith, datalong);
                        nHeight = nHeight + 120;
                    }
                }
                ...
                if (RestTypeHeight == 2700)
                {
                    ...
                    Insert30_2700Element(Elevation, DimTypeH, endWallX, IsRiji, true, dimTypeVertical, currentDefaultDisign, ListRenderElement, dataCordenadX, dataCordenadY, nHeight, dataWith, datalong);
                    LastPanel = 1200;
                }
            }
        }
        private static void Insert30_2700Element(long Elevation, DimType DimTypeH, long endWallX, long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long datalong)
        {
            if (nHeight != 0)
            {
        ...
        private static void Insert30_1200Element(long Elevation, DimType DimTypeH, bool CHeck750R, long endWallX, long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long datalong)
        {
            if (nHeight == 0)
            {
                DimTypeH = DimType.Horizontal;
            ...
            CommonElement.SedUnionVertical(90, 0, 0, endWallX, 0, dataCordenadY - PanelPerfil, nHeight + 20, ListRenderElement, "");
            CommonElement.SedUnionVertical(90, 0, 0, endWallX, 0, dataCordenadY - PanelPerfil, nHeight + 80, ListRenderElement, "");

            CommonElement.SedUnionVertical(180, +PanelPerfil, 0, endWallX - 12, 0, dataCordenadY, nHeight + 20, ListRenderElement, "");
            CommonElement.SedUnionVertical(180, +PanelPerfil, 0, endWallX - 12, 0, dataCordenadY, nHeight + 80, ListRenderElement, "");

            CommonElement.SedUnionVertical(270, +PanelPerfil, 0, endWallX, -PanelPerfil, dataCordenadY + (dataWith / 10) + 12, nHeight + 20, ListRenderElement, "");
            CommonElement.SedUnionVertical(270, +PanelPerfil, 0, endWallX, -PanelPerfil, dataCordenadY + (dataWith / 10) + 12, nHeight + 80, ListRenderElement, "");
            //180 simetrico
            CommonElement.SedUnionVertical(1801, +PanelPerfil, 0, endWallX - 12, 0, dataCordenadY + (dataWith / 10), nHeight + 20, ListRenderElement, "");
            CommonElement.SedUnionVertical(1801, +PanelPerfil, 0, endWallX - 12, 0, dataCordenadY + (dataWith / 10), nHeight + 80, ListRenderElement, "");
            ModelRenderElement element = new ModelRenderElement();
            switch (dataWith)
            {
                case 300:
        ...
        private static void Insert30_2400Element(long Elevation, DimType DimTypeH, bool CHeck750R, long endWallX, long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long datalong)
        {
            if (nHeight == 0)
            {
                DimTypeH = DimType.Horizontal;
