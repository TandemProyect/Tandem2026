...
{
    public class Remate0 : BaseController
    {
        ...
        private static void SedElement(long rest, long DataHeight, long datalong, long dataCordenadX, long dataCordenadY, long dataWith, List<ModelRenderElement> ListRenderElement)
        {
            ...
            if (n >= 1)
            {
                for (int i = 0; i < n; i++)
                {
                    CommonElement.SedUnionVerticalRegulable0(nHeight + 45, rest / 10, dataCordenadX, dataCordenadY, ListRenderElement, DataHeight);
                    CommonElement.SedUnionVerticalRegulable0(nHeight + 135, rest / 10, dataCordenadX, dataCordenadY, ListRenderElement, DataHeight);
                    CommonElement.SedUnionVerticalRegulable0(nHeight + 225, rest / 10, dataCordenadX, dataCordenadY, ListRenderElement, DataHeight);
                    nHeight = nHeight + 270;
            ...
            if (restHeight > 0)
            {
                ...
                {
                    CommonElement.SedUnionVerticalRegulable0(nHeight + 45, rest / 10, dataCordenadX, dataCordenadY, ListRenderElement, DataHeight);
                    CommonElement.SedUnionVerticalRegulable0(nHeight + 190, rest / 10, dataCordenadX, dataCordenadY, ListRenderElement, DataHeight);
                }
                if (RestTypeHeight == 1200)
                {
                    CommonElement.SedUnionVerticalRegulable0(nHeight + 20, rest / 10, dataCordenadX, dataCordenadY, ListRenderElement, DataHeight);
                    CommonElement.SedUnionVerticalRegulable0(nHeight + 70, rest / 10, dataCordenadX, dataCordenadY, ListRenderElement, DataHeight);
                }
            }
        }
