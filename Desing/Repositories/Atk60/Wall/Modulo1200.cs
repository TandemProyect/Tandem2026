...
{
    public class Modulo1200 : BaseController
    {
        ...
        internal static List<ModelRenderElement> setdListElement(string Tape_180o90, string Tape_0o270, long EndWallX, long EndWallY, long LongLeft, long LongRight, bool IsFirstModule, bool IsDimActive, long type, DAL.TSql_DefaultDesign currentDefaultDisign, long DataHeight, long dataWith, long datalong, long dataCordenadX, long dataCordenadY, RotateMesh meshRotateX, RotateMesh meshRotateMirrowX, string dataRotateZ, long _Type, bool _isEndModule, bool _HasPreviousModule, long _DataSupEnd)
        {
            ...
            if (_DataSupEnd == 0)
            {
                if (_isEndModule == true)
                {
                    if (type == 1)
                    {
                        dataCordenadX = EndWallX - 120;
                    }
                    if (type == 2)
                    {
                        dataCordenadY = EndWallY - 120;
                    }
                }
            }
            ...
            InsertProp.SedProp(dataWith, LongLeft, DataHeight, _Type, dataCordenadX, dataCordenadY, ListRenderElement, 29, 30, 60, 61, true);
        ...
        private static void SedPanels(bool IsFirstModule, bool _isDimActive, long type, DAL.TSql_DefaultDesign currentDefaultDisign, long DataHeight, long datalong, long dataCordenadX, long dataCordenadY, long dataWith, List<ModelRenderElement> ListRenderElement, long _Type, bool _isEndModule, bool _HasPreviousModule)
        {
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    if (_isEndModule == true)
                    {
                        //CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
                        //CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                    }
                    else
                    {
                        CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
                        CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 45, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 135, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 225, ListRenderElement, "");
                        CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 45, ListRenderElement, dataWith / 10, "");
                        CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 135, ListRenderElement, dataWith / 10, "");
                        CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 225, ListRenderElement, dataWith / 10, "");
                    }
                    //Horisontal
                    if (i == 0)
                    {
                    ...
                    else
                    {
                        ...
                        CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 100, dataCordenadY, Elevation - 30, ListRenderElement, dataWith / 10, "");
                        ...
                        CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 100, dataCordenadY, Elevation - 30, ListRenderElement, dataWith / 10, "");

                        CommonElement.SedUnionHorizontal(type, PanelPerfil, 0, dataCordenadX, 20, dataCordenadY, nHeight, ListRenderElement, "90");
                        CommonElement.SedUnionHorizontal(type, PanelPerfil, 0, dataCordenadX, 75, dataCordenadY, nHeight, ListRenderElement, "90");
                        ...
                        CommonElement.SedUnionHorizontalMirror(type, PanelPerfil, 0, dataCordenadX, 75, dataCordenadY, nHeight, ListRenderElement, dataWith / 10, "90");
                    }
                    ...
                    CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 300, type, 90, DimType.Horizontal, type.ToString(), "", 0);
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    elements3.Element = Atk60Element.GetElement("Panel30270");
                    elements3.ElementF = Atk60Element.GetElement("Panel30270F");
                    elements3.CodeName = "27304205";
                    elements3.z = elements3.z + nHeight;
                    elements3.x = dataCordenadX + 120;
                    elements3.y = (dataCordenadY - dataWith / 10);
                    elements3.XRotate = 180;
                    if (type == 2)
                    {
                        elements3.y = dataCordenadY + 90;
        ...
        private static void Insert300Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong)
        {
            if (IsDywidagT == true)
            {
                CommonElement.SedDiwydagD(type, PanelPerfil, 5, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 4, true);
                CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 4, true);
            }
            CommonElement.SedDiwydagD(type, PanelPerfil, 5, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 26, false);
            CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 26, false);
            var LongPanel = 300;
            var NexHeight = 22;
            if (IsEndModule != true)
            {
                if (LongPanel != 300)
                {
                    CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 5, ListRenderElement, "");
                    CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 5, ListRenderElement, dataWith / 10, "");
                }
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + NexHeight, ListRenderElement, "");
                CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + NexHeight, ListRenderElement, dataWith / 10, "");
            }
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 100, dataCordenadY, nHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 30, dataCordenadY, nHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 100, dataCordenadY, nHeight, ListRenderElement, dataWith / 10, "");
            }
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 300, type, 0, DimType.Horizontal, type.ToString(), "", 0);
            ModelRenderElement element = new ModelRenderElement();
            ...
            {
                element.XRotate = 270;
                element.y = dataCordenadY + 120;
            }
            ListRenderElement.Add(element);
            //Mirror
            ModelRenderElement element4 = new ModelRenderElement();
            element4.Element = Atk60Element.GetElement("Panel30120T");
            element4.ElementF = Atk60Element.GetElement("Panel30120TF");
            element4.CodeName = "12304211";
            element4.z = element4.z + nHeight;
            element4.x = dataCordenadX + 120;
        ...
        {
            CommonElement.SedDiwydagD(type, PanelPerfil, 5, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 41, false);
            CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 41, false);
            if (IsDywidagT == true)
            {
                CommonElement.SedDiwydagD(type, PanelPerfil, 5, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 4, true);
                CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 4, true);
            ...
            if (IsEndModule != true && HasPreviousModule == true)
            {
                ...
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + NexHeight, ListRenderElement, "");
                CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + NexHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 15, ListRenderElement, "");
                CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 15, ListRenderElement, dataWith / 10, "");
            }
            else
            {
                if (IsEndModule != true)
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 100, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                ...
                CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 100, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
            }
            ...
            //Mirror
            ModelRenderElement element4 = new ModelRenderElement();
            element4.Element = Atk60Element.GetElement("Panel45120T");
            element4.ElementF = Atk60Element.GetElement("Panel45120TF");
        ...
        private static void Insert600ElementT(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong)
        {
            ...
            if (IsDywidagT == true)
            {
                CommonElement.SedDiwydagD(type, PanelPerfil, 5, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 53, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 53, false);
            }
            var LongPanel = 600;
            var NexHeight = 53;
            if (IsEndModule != true && HasPreviousModule == true)
            ...
            if (IsRiji == 1 || IsRiji == 2)
            {
                ...
                CommonElement.UnionRiji(IsRiji, type, PanelPerfil, 0, dataCordenadX, 100, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                ...
                CommonElement.UnionRijiMirror(IsRiji, type, PanelPerfil, 0, dataCordenadX, 100, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
            }
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 1200, type, 0, DimType.Horizontal, type.ToString(), "", 0);

            ModelRenderElement element = new ModelRenderElement();
            element.Element = Atk60Element.GetElement("Panel60120T");
            element.ElementF = Atk60Element.GetElement("Panel60120TF");
            ...
            //Mirror
            ModelRenderElement element4 = new ModelRenderElement();
            element4.Element = Atk60Element.GetElement("Panel60120T");
            element4.ElementF = Atk60Element.GetElement("Panel60120TF");
            element4.CodeName = "12604213";
            element4.z = element4.z + nHeight;
            element4.x = dataCordenadX + 120;
            element4.y = (dataCordenadY - dataWith / 10);
            element4.XRotate = 180;
        ...
        private static void Insert900ElementT(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong)
        {
            if (IsDywidagT == true)
            {
                CommonElement.SedDiwydagD(type, PanelPerfil, 5, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 83, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 83, false);
            }
            CommonElement.SedDiwydagD(type, PanelPerfil, 5, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 4, true);
            CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 4, true);
        ...
        private static void Insert1200Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule)
        {
            ...
            if (IsEndModule != true)
            {
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 20, ListRenderElement, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 80, ListRenderElement, "");
                CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 20, ListRenderElement, dataWith / 10, "");
                CommonElement.SedUnionVerticalMirror(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 80, ListRenderElement, dataWith / 10, "");
                CommonElement.SedDiwydagD(type, PanelPerfil, 120, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 35, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 120, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 115, false);
            }
            else
            {
                //CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 35, false);
                //CommonElement.SedDiwydagD(type, PanelPerfil, 110, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 115, false);
            }
            if (nHeight != 0)
            {
                CommonElement.SedUnionHorizontal(type, PanelPerfil, 0, dataCordenadX, 20, dataCordenadY, nHeight, ListRenderElement, "90");
            ...
            if (IsRiji == 2)
            {
                ...
                CommonElement.UnionRiji(2, type, PanelPerfil, 0, dataCordenadX, 100, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                ...
                CommonElement.UnionRijiMirror(2, type, PanelPerfil, 0, dataCordenadX, 100, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
            }
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 900, type, 0, DimType.Horizontal, type.ToString(), "", 0);
            ModelRenderElement element = new ModelRenderElement();
            ...
            element3.Element = Atk60Element.GetElement("Panel30120");
            element3.ElementF = Atk60Element.GetElement("Panel30120F");
            element3.CodeName = "12304211";
            element3.z = element3.z + nHeight;
            element3.x = dataCordenadX + 90;
            element3.y = dataCordenadY;
            element3.XRotate = 0;
            if (type == 2)
            {
                element3.XRotate = 270;
                element3.y = dataCordenadY + 120;
            ...
            element6.Element = Atk60Element.GetElement("Panel30120");
            element6.ElementF = Atk60Element.GetElement("Panel30120F");
            element6.CodeName = "12304211";
            element6.z = element6.z + nHeight;
            element6.x = dataCordenadX + 120;
        ...
        private static void Insert2400Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule)
        {
            ...
            else
            {
                if (IsEndModule != true)
                {
                    ...
                    CommonElement.SedDiwydagD(type, PanelPerfil, 120, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
                    CommonElement.SedDiwydagD(type, PanelPerfil, 120, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                    CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 40, ListRenderElement, "");
                    CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX, 120, dataCordenadY, nHeight + 120, ListRenderElement, "");
                }
                else
                {
                    CommonElement.SedDiwydagD(type, PanelPerfil, 0, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 30, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 85, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 30, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 85, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
            }
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 900, type, 0, DimType.Horizontal, type.ToString(), "", 0);
            ...
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 300, type, 90, DimType.Horizontal, type.ToString(), "", 0);
            ModelRenderElement element3 = new ModelRenderElement();
            element3.Element = Atk60Element.GetElement("Panel30240");
            element3.ElementF = Atk60Element.GetElement("Panel30240F");
            element3.CodeName = "12304211";
            element3.z = element3.z + nHeight;
            element3.x = dataCordenadX + 90;
            element3.y = dataCordenadY;
            ...
            ModelRenderElement element6 = new ModelRenderElement();
            element6.Element = Atk60Element.GetElement("Panel30240");
            element6.ElementF = Atk60Element.GetElement("Panel30240F");
            element6.CodeName = "12304211";
            element6.z = element6.z + nHeight;
            element6.x = dataCordenadX + 120;
            element6.y = (dataCordenadY - dataWith / 10);
