...
{
    public class SedUSExS2_180_270 : BaseController
    {
            ...
            if (restHeight > 0)
            {
                ...
                if (RestTypeHeight == 2400)
                {
                    ...
                    else
                    {
                        ...
                        ModelRenderElement elementGanchon = new ModelRenderElement();
                        elementGanchon.Element = Atk60Element.GetUnion("GanchoCierre");
                        elementGanchon.ElementF = "";
                        elementGanchon.CodeName = "1920811";
                        elementGanchon.Type = "";
                        elementGanchon.x = endWallX;
                        elementGanchon.y = dataCordenadY + 6;
                        elementGanchon.z = elementGanchon.z + nHeight + 155;
                        elementGanchon.XRotate = 270;
                        ListRenderElement.Add(elementGanchon);

                        ModelRenderElement elementTuercaFijan = new ModelRenderElement();
                        elementTuercaFijan.ElementUnion1 = Atk60Element.GetUnion("TuercaFija");
                        elementTuercaFijan.CodeName = "10443020";
                        elementTuercaFijan.x = endWallX + 12;
                        elementTuercaFijan.y = dataCordenadY + 15;
                        elementTuercaFijan.z = elementTuercaFijan.z + nHeight + 155;
                        elementTuercaFijan.XRotate = 1;
                        elementTuercaFijan.ZRotate = "0";
                        ListRenderElement.Add(elementTuercaFijan);
                        ...
                        elementGancho2n.y = dataCordenadY + 6;
                        elementGancho2n.z = elementGancho2n.z + nHeight + 235;
                        elementGancho2n.XRotate = 270;
                        ...
                        elementTuercaFija2n.y = dataCordenadY + 15;
                        elementTuercaFija2n.z = elementTuercaFija2n.z + nHeight + 235;
