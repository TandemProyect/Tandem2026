...
{
    public class SedAng_180_Esq_270 : BaseController
    {
        private static string _codeName;
        internal static List<ModelRenderElement> setdListElement(long endWallX, DAL.TSql_DefaultDesign currentDefaultDisign, long DataHeight, long dataWith, long datalong, long dataCordenadX, long dataCordenadY)
        {
            ...
            if (n >= 1)
            {
                for (int i = 0; i < n; i++)
                {
                    ...
                    elementTuercaFija.x = endWallX;
                    elementTuercaFija.y = dataCordenadY + 6;
                    ...
                    elementTuercaFija2.x = endWallX;
                    elementTuercaFija2.y = dataCordenadY + 6;
                    ...
                    elementTuercaFija3.x = endWallX;
                    elementTuercaFija3.y = dataCordenadY + 6;
                    ...
                    elementGancho01.y = dataCordenadY;
                    ...
                    elementTuercaFija01.y = dataCordenadY;
                    ...
                    elementTuercaFija012.y = dataCordenadY - 6;
                    ...
                    elementGancho02.y = dataCordenadY;
                    ...
                    elementTuercaFija02.y = dataCordenadY;
                    ...
                    elementTuercaFija022.y = dataCordenadY - 6;
                    ...
                    elementGancho03.y = dataCordenadY;
                    ...
                    elementTuercaFija04.y = dataCordenadY;
                    ...
                    elementTuercaFija025.y = dataCordenadY - 6;
            ...
            if (restHeight > 0)
            {
                ...
                if (RestTypeHeight == 2400)
                {
                    ...
                    else
                    {
                        ...
                        element2.XRotate = 0;
                        element2.z = element.z + nHeight + 120;
                    ...
                    elementTuercaFija025.x = endWallX - 6;
                    elementTuercaFija025.y = dataCordenadY - 6;
                    elementTuercaFija025.z = elementTuercaFija025.z + nHeight + 225;
                    elementTuercaFija025.XRotate = 271;
                    elementTuercaFija025.ZRotate = "0";
                    ListRenderElement.Add(elementTuercaFija025);
                }
