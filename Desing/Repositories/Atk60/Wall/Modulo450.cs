...
{
    public class Modulo450 : BaseController
    {
        ...
        internal static List<ModelRenderElement> setdListElement(string Tape_180o90, string Tape_0o270, long EndWallX, long EndWallY, long LongLeft, long LongRight, bool IsFirstModule, bool IsDimActive, long type, DAL.TSql_DefaultDesign currentDefaultDisign, long DataHeight, long dataWith, long datalong, long dataCordenadX, long dataCordenadY, RotateMesh meshRotateX, RotateMesh meshRotateMirrowX, string dataRotateZ, long _Type, bool _isEndModule, bool _HasPreviousModule, long _DataSupEnd)
        {
            ...
            //        if (type == 1)
            //        {
            //            dataCordenadX = EndWallX - 45;
            //        }
            //        if (type == 2)
            //        {
            //            dataCordenadY = EndWallY - 45;
            //        }
            //    }
            //}
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    else
                    {
                        ...
                        CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 27, dataCordenadY, Elevation - 30, ListRenderElement, dataWith / 10, "");
                        CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 27, dataCordenadY, Elevation - 30, ListRenderElement, dataWith / 10, "");
        ...
        private static void Insert2700Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule, bool _HasPreviousModule)
        {
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 27, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 27, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.SedUnionHorizontal(type, PanelPerfil, 0, dataCordenadX, 15, dataCordenadY, nHeight, ListRenderElement, "90");
                CommonElement.SedUnionHorizontalMirror(type, PanelPerfil, 0, dataCordenadX, 15, dataCordenadY, nHeight, ListRenderElement, dataWith / 10, "90");
            }
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 450, type, 0, DimType.Horizontal, type.ToString(), "", 0);
        ...
        private static void Insert1200Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule, bool _HasPreviousModule)
        {
            if (_isEndModule != true)
            {
                ...
                CommonElement.SedDiwydagD(type, PanelPerfil, 45, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 5, true);
            }
            else
            {
                //if (nHeight != 0)
                //{
                //    CommonElement.SedDiwydagD(type, PanelPerfil, 35, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 115, false);
                //}
                //CommonElement.SedDiwydagD(type, PanelPerfil, 35, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 5, true);
            }
            if (_HasPreviousModule != true)
            {
                if (nHeight != 0)
                ...
                CommonElement.SedDiwydagD(type, PanelPerfil, 0, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 5, true);
            }
            var SupNHeight = 120;
            if (IsRiji == 1)
            {
