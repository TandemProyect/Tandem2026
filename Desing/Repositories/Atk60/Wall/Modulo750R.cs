...
{
    public class Modulo750R : BaseController
    {
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    if (_isEndModule != true)
                    {
                        ...
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 75, 0, dataCordenadY, nHeight + 45, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 75, 0, dataCordenadY, nHeight + 135, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 75, 0, dataCordenadY, nHeight + 225, ListRenderElement, "");
                    }
                    else
                    {
                    ...
                    CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 750, type, 0, DimType.Horizontal, type.ToString(), "", 0);
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    elements11.Element = Atk60Element.GetElement("PanelReg270");
                    elements11.ElementF = Atk60Element.GetElement("PanelReg270F");
                    elements11.CodeName = "27104219";
                    elements11.z = elements11.z + nHeight;
                    elements11.x = dataCordenadX + 75;
        ...
        private static void Insert2700Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule, bool _HasPreviousModule)
        {
            ...
            element4.Element = Atk60Element.GetElement("PanelReg270");
            element4.ElementF = Atk60Element.GetElement("PanelReg270F");
            element4.CodeName = "27104219";
            element4.z = element4.z + nHeight;
            element4.x = dataCordenadX + 75;
        ...
        private static void Insert1200Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule, bool _HasPreviousModule)
        {
            ...
            //Mirror
            ModelRenderElement element4 = new ModelRenderElement();
            element4.Element = Atk60Element.GetElement("PanelReg120");
            element4.ElementF = Atk60Element.GetElement("PanelReg120F");
            element4.CodeName = "12104120";
            element4.z = element4.z + nHeight;
            element4.x = dataCordenadX + 75;
            element4.y = (dataCordenadY - dataWith / 10);
            element4.XRotate = 180;
        ...
        private static void Insert2400Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule, bool _HasPreviousModule)
        {
            ...
            //Mirror
            ModelRenderElement element4 = new ModelRenderElement();
            element4.Element = Atk60Element.GetElement("PanelReg240");
            element4.ElementF = Atk60Element.GetElement("PanelReg240F");
            element4.CodeName = "24104224";
            element4.z = element4.z + nHeight;
            element4.x = dataCordenadX + 75;
            element4.y = (dataCordenadY - dataWith / 10);
            element4.XRotate = 180;
