...
{
    public class CornerPanel270_45 : BaseController
    {
        ...
        private static void SedPanels(long type, DAL.TSql_DefaultDesign currentDefaultDisign, long DataHeight, long datalong, long dataCordenadX, long dataCordenadY, long dataWith, List<ModelRenderElement> ListRenderElement, bool IsAngular)
        {
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    if (IsAngular == true)
                    {
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 45, 0, dataCordenadY, nHeight + 45, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 45, 0, dataCordenadY, nHeight + 135, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 45, 0, dataCordenadY, nHeight + 225, ListRenderElement, "");
                    }
        ...
        private static void Insert1200Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool IsAngular)
        {
            ...
            if (IsAngular == true)
            {
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 45, 0, dataCordenadY, nHeight + 20, ListRenderElement, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 45, 0, dataCordenadY, nHeight + 80, ListRenderElement, "");
            }
        ...
        private static void Insert2400Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool IsAngular)
        {
            ...
            if (IsAngular == true)
            {
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 45, 0, dataCordenadY, nHeight + 40, ListRenderElement, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 45, 0, dataCordenadY, nHeight + 200, ListRenderElement, "");
            }
