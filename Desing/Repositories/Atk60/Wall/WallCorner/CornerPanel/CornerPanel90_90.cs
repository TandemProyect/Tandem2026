...
{
    public class CornerPanel90_90 : BaseController
    {
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    else
                    {
                        ...
                        CommonElement.SedUnionHorizontalMirror(4, PanelPerfil, 0, dataCordenadX - 90, 40, dataCordenadY, nHeight, ListRenderElement, 0, "90");
                        CommonElement.SedUnionHorizontalMirror(4, PanelPerfil, 0, dataCordenadX - 75, 15, dataCordenadY, nHeight, ListRenderElement, 0, "90");

                    }
                    CommonElement.SedUnionVertical(90, PanelPerfil, 0, dataCordenadX - 90, 0, dataCordenadY - 12, nHeight + 45, ListRenderElement, "");
                    CommonElement.SedUnionVertical(90, PanelPerfil, 0, dataCordenadX - 90, 0, dataCordenadY - 12, nHeight + 135, ListRenderElement, "");
                    CommonElement.SedUnionVertical(90, PanelPerfil, 0, dataCordenadX - 90, 0, dataCordenadY - 12, nHeight + 225, ListRenderElement, "");
        ...
        private static void Insert1200Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong)
        {
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.SedUnionHorizontalMirror(4, PanelPerfil, 0, dataCordenadX - 90, 15, dataCordenadY, nHeight + SupNHeight, ListRenderElement, 0, "90");
                CommonElement.SedUnionHorizontalMirror(4, PanelPerfil, 0, dataCordenadX - 60, 40, dataCordenadY, nHeight + SupNHeight, ListRenderElement, 0, "90");

            }
            CommonElement.SedUnionVertical(90, PanelPerfil, 0, dataCordenadX - 90, 0, dataCordenadY - 12, nHeight + 20, ListRenderElement, "");
            CommonElement.SedUnionVertical(90, PanelPerfil, 0, dataCordenadX - 90, 0, dataCordenadY - 12, nHeight + 80, ListRenderElement, "");
        ...
        private static void Insert2400Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong)
        {
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 25, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.SedUnionHorizontalMirror(4, PanelPerfil, 0, dataCordenadX, 20, dataCordenadY - 90, nHeight, ListRenderElement, 0, "90");
                CommonElement.SedUnionHorizontalMirror(4, PanelPerfil, 0, dataCordenadX, 60, dataCordenadY - 75, nHeight, ListRenderElement, 0, "90");
            }
            CommonElement.SedUnionVertical(90, PanelPerfil, 0, dataCordenadX - 90, 0, dataCordenadY - 12, nHeight + 40, ListRenderElement, "");
            CommonElement.SedUnionVertical(90, PanelPerfil, 0, dataCordenadX - 90, 0, dataCordenadY - 12, nHeight + 200, ListRenderElement, "");
