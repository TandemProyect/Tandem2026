...
{
    public class CornerPanel270_1050 : BaseController
    {
        ...
        private static void SedPanels(long type, DAL.TSql_DefaultDesign currentDefaultDisign, long DataHeight, long datalong, long dataCordenadX, long dataCordenadY, long dataWith, List<ModelRenderElement> ListRenderElement, bool IsAngular)
        {
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    if (IsAngular == true)
                    {
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 105, 0, dataCordenadY, nHeight + 45, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 105, 0, dataCordenadY, nHeight + 135, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 105, 0, dataCordenadY, nHeight + 225, ListRenderElement, "");
                    }
                    ...
                    element45.Element = Atk60Element.GetElement("Panel45270");
                    element45.ElementF = Atk60Element.GetElement("Panel45270F");
                    element45.CodeName = "27454206";
                    element45.LongDimTypeHorizontal = (long?)450;
                    element45.LongDimTypeVertical = (long?)2700;
                    element45.x = dataCordenadX + 60;
                    element45.y = dataCordenadY;
                    element45.z = element45.z + nHeight;
                    element45.XRotate = 0;
                    ListRenderElement.Add(element45);
                    nHeight = nHeight + 270;
                }
            }
            if (restHeight > 0)
        ...
        private static void Insert1200Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool IsAngular)
        {
            ...
            if (IsAngular == true)
            {
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 105, 0, dataCordenadY, nHeight + 20, ListRenderElement, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 105, 0, dataCordenadY, nHeight + 80, ListRenderElement, "");
            }
            ...
            ModelRenderElement element45 = new ModelRenderElement();
            element45.Element = Atk60Element.GetElement("Panel45120");
            element45.ElementF = Atk60Element.GetElement("Panel45120F");
            element45.LongDimTypeHorizontal = (long?)450;
            element45.LongDimTypeVertical = (long?)1200;
            element45.CodeName = "12454212";
            element45.z = element45.z + nHeight;
            element45.x = dataCordenadX + 60;
            element45.y = dataCordenadY;
            element45.XRotate = 0;
        ...
        private static void Insert2400Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool IsAngular)
        {
            ...
            if (IsAngular == true)
            {
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 105, 0, dataCordenadY, nHeight + 40, ListRenderElement, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 105, 0, dataCordenadY, nHeight + 200, ListRenderElement, "");
            }
            ModelRenderElement element = new ModelRenderElement();
            ...
            ModelRenderElement element45 = new ModelRenderElement();
            element45.Element = Atk60Element.GetElement("Panel45240");
            element45.ElementF = Atk60Element.GetElement("Panel45240F");
            element45.LongDimTypeHorizontal = (long?)450;
            element45.LongDimTypeVertical = (long?)2400;
            element45.CodeName = "24454243";
            element45.z = element45.z + nHeight;
            element45.x = dataCordenadX + 60;
            element45.y = dataCordenadY;
            element45.XRotate = 0;
