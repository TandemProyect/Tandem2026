...
{
    public class CornerPanel180_90 : BaseController
    {
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    else
                    {
                        ...
                        CommonElement.SedUnionHorizontalMirror(2, PanelPerfil, 0, dataCordenadX, 40, dataCordenadY + 90, nHeight, ListRenderElement, 0, "90");
                        CommonElement.SedUnionHorizontalMirror(2, PanelPerfil, 0, dataCordenadX, 15, dataCordenadY + 90, nHeight, ListRenderElement, 0, "90");

                    }
                    CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 90, nHeight + 45, ListRenderElement, "");
                    CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 90, nHeight + 135, ListRenderElement, "");
                    CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 90, nHeight + 225, ListRenderElement, "");
                    if (IsAngular_00 == false)
                    {
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 180, nHeight + 45, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 180, nHeight + 135, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 180, nHeight + 225, ListRenderElement, "");
                    }
        ...
        private static void Insert1200Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong)
        {
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX - 12, 25, dataCordenadY + 115, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.SedUnionHorizontalMirror(2, PanelPerfil, 0, dataCordenadX, 15, dataCordenadY + 90, nHeight + SupNHeight, ListRenderElement, 0, "90");
                CommonElement.SedUnionHorizontalMirror(2, PanelPerfil, 0, dataCordenadX, 40, dataCordenadY + 90, nHeight + SupNHeight, ListRenderElement, 0, "90");
            ...
            if (IsAngular_00 == false)
            {
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 180, nHeight + 20, ListRenderElement, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 180, nHeight + 80, ListRenderElement, "");
            }
            ModelRenderElement element = new ModelRenderElement();
        ...
        private static void Insert2400Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong)
        {
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX - 12, 25, dataCordenadY + 115, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.SedUnionHorizontalMirror(1, PanelPerfil, 0, dataCordenadX, 20, dataCordenadY + 90, nHeight, ListRenderElement, 0, "90");
                CommonElement.SedUnionHorizontalMirror(1, PanelPerfil, 0, dataCordenadX, 60, dataCordenadY + 90, nHeight, ListRenderElement, 0, "90");
            }
            ...
            if (IsAngular_00 == false)
            {
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 180, nHeight + 40, ListRenderElement, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 180, nHeight + 200, ListRenderElement, "");
            }
