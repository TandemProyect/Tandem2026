...
{
    public class CornerPanel180_75 : BaseController
    {
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    else
                    {
                        ...
                        CommonElement.UnionRiji(2, type, PanelPerfil, 0, dataCordenadX - 12, 25, dataCordenadY + 100, Elevation - 30, ListRenderElement, dataWith / 10, "");
                        CommonElement.SedUnionHorizontalMirror(2, PanelPerfil, 0, dataCordenadX + 75, 40, dataCordenadY, nHeight, ListRenderElement, 0, "90");
                        CommonElement.SedUnionHorizontalMirror(2, PanelPerfil, 0, dataCordenadX + 75, 15, dataCordenadY, nHeight, ListRenderElement, 0, "90");

                    }
                    CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 75, nHeight + 45, ListRenderElement, "");
                    CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 75, nHeight + 135, ListRenderElement, "");
                    CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 75, nHeight + 225, ListRenderElement, "");
                    if (IsAngular_00 == false)
                    {
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 150, nHeight + 45, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 150, nHeight + 135, ListRenderElement, "");
                        CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 150, nHeight + 225, ListRenderElement, "");
                    }
        ...
        private static void Insert1200Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong)
        {
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil - 12, 0, dataCordenadX + 12, 25, dataCordenadY + 100, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.SedUnionHorizontalMirror(2, PanelPerfil, 0, dataCordenadX, 15, dataCordenadY + 75, nHeight + SupNHeight, ListRenderElement, 0, "90");
                CommonElement.SedUnionHorizontalMirror(2, PanelPerfil, 0, dataCordenadX, 40, dataCordenadY + 75, nHeight + SupNHeight, ListRenderElement, 0, "90");

            }
            CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 75, nHeight + 20, ListRenderElement, "");
            CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 75, nHeight + 80, ListRenderElement, "");
            if (IsAngular_00 == false)
            {
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 150, nHeight + 20, ListRenderElement, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 150, nHeight + 80, ListRenderElement, "");
            }
            ModelRenderElement element = new ModelRenderElement();
        ...
        private static void Insert2400Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong)
        {
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX - 12, 25, dataCordenadY + 100, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.SedUnionHorizontalMirror(1, PanelPerfil, 0, dataCordenadX, 20, dataCordenadY + 75, nHeight, ListRenderElement, 0, "90");
                CommonElement.SedUnionHorizontalMirror(1, PanelPerfil, 0, dataCordenadX, 60, dataCordenadY + 75, nHeight, ListRenderElement, 0, "90");
            }
            CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 75, nHeight + 40, ListRenderElement, "");
            CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 75, nHeight + 200, ListRenderElement, "");
            if (IsAngular_00 == false)
            {
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 150, nHeight + 40, ListRenderElement, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX - 12, 0, dataCordenadY + 150, nHeight + 200, ListRenderElement, "");
            }
            ModelRenderElement element = new ModelRenderElement();
