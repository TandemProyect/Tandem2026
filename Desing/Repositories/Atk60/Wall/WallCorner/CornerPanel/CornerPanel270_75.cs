...
{
    public class CornerPanel270_75 : BaseController
    {
        ...
        private static void Insert1200Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool IsAngular)
        {
            ...
            if (IsAngular == true)
            {
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 75, 0, dataCordenadY, nHeight + 20, ListRenderElement, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 75, 0, dataCordenadY, nHeight + 80, ListRenderElement, "");
            }
        ...
        private static void Insert2400Element(long IsRiji, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool IsAngular)
        {
            ...
            if (IsAngular == true)
            {
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 75, 0, dataCordenadY, nHeight + 40, ListRenderElement, "");
                CommonElement.SedUnionVertical(type, PanelPerfil, 0, dataCordenadX + 75, 0, dataCordenadY, nHeight + 200, ListRenderElement, "");
            }
