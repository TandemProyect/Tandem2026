...
{
    public class ModuloWallEsqTEsq_20_00 : BaseController
    {
        ...
        )
        {
            ...
            switch (testLong)
            {
                case "450":
                    ...
                    break;
                case "600":
                    ListRenderElementPanel90 = Wall.WallCorner.CornerPanel90_60.setdListElement(type, currentDefaultDisign, dataHeight, dataWith, datalong, dataCordenadX, dataCordenadY/* - dataWith / 10*/);
                    break;
                case "750":
                    ListRenderElementPanel90 = Wall.WallCorner.CornerPanel90_75.setdListElement(type, currentDefaultDisign, dataHeight, dataWith, datalong, dataCordenadX, dataCordenadY/* - dataWith / 10*/);
                    break;
                case "900":
                    ListRenderElementPanel90 = Wall.WallCorner.CornerPanel90_90.setdListElement(type, currentDefaultDisign, dataHeight, dataWith, datalong, dataCordenadX, dataCordenadY/* - dataWith / 10*/);
                    break;
                case "1050":
