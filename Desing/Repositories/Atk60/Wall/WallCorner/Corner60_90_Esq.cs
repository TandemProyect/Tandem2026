...
{
    public class Corner60_90_Esq : BaseController
    {
        ...
        internal static List<ModelRenderElement> setdListElement(long type, DAL.TSql_DefaultDesign currentDefaultDisign, long DataHeight, long dataWith, long datalong, long dataCordenadX, long dataCordenadY)
        {
            ...
            SedPanels(type, currentDefaultDisign, dataWith, DataHeight, dataCordenadX, dataCordenadY, datalong, ListRenderElement);
        ...
        {
            //dataCordenadX = (dataCordenadX + (datalong / 10)) - dataWith / 10;
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    element.x = dataCordenadX - dataWith / 10;
