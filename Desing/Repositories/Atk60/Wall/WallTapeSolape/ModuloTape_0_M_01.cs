...
{
    public class ModuloTape_0_M_01 : BaseController
    {
        ...
        {
            var Remate = dataCordenadX - endWallX;
            {
            ...
            if (n >= 1)
            {
                for (int i = 0; i < n; i++)
                {
                    CommonElement.SedUnionHorizontal_0_01(DataHeight, 0, dataCordenadX, currentDefaultDisign, nHeight + 65, datalong, endWallX, dataCordenadY, dataWith, ListRenderElement);
                    CommonElement.SedUnionHorizontal_0_01(DataHeight, 0, dataCordenadX, currentDefaultDisign, nHeight + 140, datalong, endWallX, dataCordenadY, dataWith, ListRenderElement);
                    CommonElement.SedUnionHorizontal_0_01(DataHeight, 0, dataCordenadX, currentDefaultDisign, nHeight + 220, datalong, endWallX, dataCordenadY, dataWith, ListRenderElement);
                    nHeight = nHeight + 270;
                }
            }
            if (restHeight > 0)
            {
                ...
                if (RestTypeHeight == 2400)
                {
                    ...
                    //{
                    CommonElement.SedUnionHorizontal_0_01(DataHeight, 0, dataCordenadX, currentDefaultDisign, nHeight + 55, datalong, endWallX, dataCordenadY, dataWith, ListRenderElement);
                    CommonElement.SedUnionHorizontal_0_01(DataHeight, 0, dataCordenadX, currentDefaultDisign, nHeight + 140, datalong, endWallX, dataCordenadY, dataWith, ListRenderElement);
                    CommonElement.SedUnionHorizontal_0_01(DataHeight, 0, dataCordenadX, currentDefaultDisign, nHeight + 225, datalong, endWallX, dataCordenadY, dataWith, ListRenderElement);
                    nHeight = nHeight + 240;
                }
                if (RestTypeHeight == 1200)
                {
                    CommonElement.SedUnionHorizontal_0_01(DataHeight, 0, dataCordenadX, currentDefaultDisign, nHeight + 25, datalong, endWallX, dataCordenadY, dataWith, ListRenderElement);
                    CommonElement.SedUnionHorizontal_0_01(DataHeight, 0, dataCordenadX, currentDefaultDisign, nHeight + 115, datalong, endWallX, dataCordenadY, dataWith, ListRenderElement);
                    nHeight = nHeight + 120;
                }
            }
        }
