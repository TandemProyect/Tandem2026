...
{
    public class Modulo300 : BaseController
    {
        ...
        internal static List<ModelRenderElement> setdListElement(string Tape_180o90, string Tape_0o270, long EndWallX, long EndWallY, long LongLeft, long LongRight, bool IsFirstModule, bool IsDimActive, long type, DAL.TSql_DefaultDesign currentDefaultDisign, long DataHeight, long dataWith, long datalong, long dataCordenadX, long dataCordenadY, RotateMesh meshRotateX, RotateMesh meshRotateMirrowX, string dataRotateZ, long _Type, bool _isEndModule, bool _HasPreviousModule, long _DataSupEnd)
        {
            ...
            if (_DataSupEnd == 0)
            {
                if (_isEndModule == true)
                {
                    if (type == 1)
                    {
                        dataCordenadX = EndWallX - 30;
                    }
                    if (type == 2)
                    {
                        dataCordenadY = EndWallY - 30;
                    }
                }
            }
        ...
        private static void SedPanels(bool IsFirstModule, bool _isDimActive, long type, DAL.TSql_DefaultDesign currentDefaultDisign, long DataHeight, long datalong, long dataCordenadX, long dataCordenadY, long dataWith, List<ModelRenderElement> ListRenderElement, long _Type, bool _isEndModule, bool _HasPreviousModule)
        {
            ...
            if (n >= 1)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    if (_isEndModule != true)
                    {
                        CommonElement.SedDiwydagD(type, PanelPerfil, 30, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
                        CommonElement.SedDiwydagD(type, PanelPerfil, 30, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                    }
                    else
                    {
                        //CommonElement.SedDiwydagD(type, PanelPerfil, 20, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 215, false);
                        //CommonElement.SedDiwydagD(type, PanelPerfil, 20, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
                    }
                    if (i == 0)
                    {
                    ...
                    else
                    {
                        ...
                        CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 15, dataCordenadY, Elevation - 30, ListRenderElement, dataWith / 10, "");
                        CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 15, dataCordenadY, Elevation - 30, ListRenderElement, dataWith / 10, "");
                        CommonElement.SedUnionHorizontal(type, PanelPerfil, 0, dataCordenadX, 25, dataCordenadY, nHeight, ListRenderElement, "90");
                        CommonElement.SedUnionHorizontalMirror(type, PanelPerfil, 0, dataCordenadX, 25, dataCordenadY, nHeight, ListRenderElement, dataWith / 10, "90");
                    }
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    elements11.Element = Atk60Element.GetElement("Panel30270");
                    elements11.ElementF = Atk60Element.GetElement("Panel30270F");
                    elements11.CodeName = "27304205";
                    elements11.z = elements11.z + nHeight;
                    elements11.x = dataCordenadX + 30;
        ...
        private static void Insert2700Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule, bool _HasPreviousModule)
        {
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 15, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 15, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.SedUnionHorizontal(type, PanelPerfil, 0, dataCordenadX, 25, dataCordenadY, nHeight, ListRenderElement, "90");
                CommonElement.SedUnionHorizontalMirror(type, PanelPerfil, 0, dataCordenadX, 25, dataCordenadY, nHeight, ListRenderElement, dataWith / 10, "90");
            }
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 300, type, 0, DimType.Horizontal, type.ToString(), "", 0);
            ...
            element4.Element = Atk60Element.GetElement("Panel30270");
            element4.ElementF = Atk60Element.GetElement("Panel302270F");
        ...
        private static void Insert1200Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule, bool _HasPreviousModule)
        {
            if (_isEndModule != true)
            {
                CommonElement.SedDiwydagD(type, PanelPerfil, 30, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 115, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 30, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 35, false);
            }
            else
            {
                //CommonElement.SedDiwydagD(type, PanelPerfil, 20, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 115, false);
                //CommonElement.SedDiwydagD(type, PanelPerfil, 20, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 35, false);
            }
            if (_HasPreviousModule != true)
            {
            ...
            if (IsRiji == 1)
            {
                ...
                CommonElement.UnionRiji(1, type, PanelPerfil, 0, dataCordenadX, 15, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.UnionRijiMirror(1, type, PanelPerfil, 0, dataCordenadX, 15, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "");
                CommonElement.SedUnionHorizontal(type, PanelPerfil, 0, dataCordenadX, 25, dataCordenadY, nHeight + SupNHeight, ListRenderElement, "90");
                CommonElement.SedUnionHorizontalMirror(type, PanelPerfil, 0, dataCordenadX, 25, dataCordenadY, nHeight + SupNHeight, ListRenderElement, dataWith / 10, "90");
            }
            CommonElement.AddDimHorizontal(nHeight, ListRenderElement, dataCordenadX, dataCordenadY, 300, type, 0, DimType.Horizontal, type.ToString(), "", 0);
            ...
            //Mirror
            ModelRenderElement element4 = new ModelRenderElement();
            element4.Element = Atk60Element.GetElement("Panel30120");
            element4.ElementF = Atk60Element.GetElement("Panel30120F");
            element4.CodeName = "12304211";
            element4.z = element4.z + nHeight;
            element4.x = dataCordenadX + 30;
            element4.y = (dataCordenadY - dataWith / 10);
            element4.XRotate = 180;
            if (type == 2)
            {
        ...
        private static void Insert2400Element(long IsRiji, bool IsDywidagT, DimType dimTypeVertical, DAL.TSql_DefaultDesign currentDefaultDisign, List<ModelRenderElement> ListRenderElement, long dataCordenadX, long dataCordenadY, int nHeight, long dataWith, long type, long datalong, bool _isEndModule, bool _HasPreviousModule)
        {
            if (_isEndModule != true)
            {
                CommonElement.SedDiwydagD(type, PanelPerfil, 30, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 185, false);
                CommonElement.SedDiwydagD(type, PanelPerfil, 30, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
            }
            else
            {
                //CommonElement.SedDiwydagD(type, PanelPerfil, 20, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 185, false);
                //CommonElement.SedDiwydagD(type, PanelPerfil, 20, dataCordenadX, dataCordenadY, nHeight, ListRenderElement, "", dataWith, 55, false);
            }
            if (_HasPreviousModule != true)
            {
            ...
            //Mirror
            ModelRenderElement element4 = new ModelRenderElement();
            element4.Element = Atk60Element.GetElement("Panel30240");
            element4.ElementF = Atk60Element.GetElement("Panel30240F");
