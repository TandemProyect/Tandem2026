    ...
    public class EmailService
    {
            ...
            object data)
        {
            if (!File.Exists(basePathTemplate))
                throw new Exception(string.Format("La plantilla{0} no se ha encotrado en el folder de plantillas", basePathTemplate));
            ...
            string content)
        {
            ...
            foreach (var item in documents)
            {
                ...
                myMessage.From = new EmailAddress("juan.godoy@vscad.com", "Juan Andrés Godoy");
