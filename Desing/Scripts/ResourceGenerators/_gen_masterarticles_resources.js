...
const es = Object.fromEntries(
  Object.entries({
    ...
    StlPreview_SaveWallsSavedToast: "Muros guardados",
    StlPreview_SaveWallsNeedDesignToast: "Abre un diseño para guardar los muros",
    StlPreview_SaveWallsErrorToast: "No se pudieron guardar los muros",
    StlPreview_DesignSaving: "Guardando diseño…",
    StlPreview_DesignLoading: "Cargando diseño…",
    StlPreview_LeaveSaveTitle: "Salir del diseño",
    StlPreview_LeaveSaveMessage: "¿Quieres guardar los muros antes de salir?",
    StlPreview_LeaveSaveYes: "Sí",
    StlPreview_LeaveSaveNo: "No",
    ...
    StlPreview_FormworkRenderingTitle: "Renderizando sistema {0}",
    StlPreview_FormworkRenderingPhaseServer: "Calculando módulos…",
    StlPreview_FormworkRenderingPhasePaint: "Pintando paneles…",
    StlPreview_FormworkRenderingRemainingSeconds: "Quedan unos {0} s",
    StlPreview_FormworkRenderingRemainingMinute: "Queda 1 min",
    StlPreview_FormworkRenderingRemainingMinutes: "Quedan unos {0} min",
    StlPreview_FormworkRenderingAlmostDone: "Casi listo…",
    ...
    StlPreview_Desing2EntornoLightingSectionTitle: "Iluminación encofrado",
    StlPreview_Desing2EntornoSunAzimuthLabel: "Azimut del sol",
    StlPreview_Desing2EntornoSunAzimuthAria: "Ángulo horizontal de la luz principal en grados.",
    StlPreview_Desing2EntornoSunElevationLabel: "Elevación del sol",
    StlPreview_Desing2EntornoSunElevationAria: "Ángulo de elevación de la luz principal en grados.",
    StlPreview_Desing2EntornoSunIntensityLabel: "Intensidad del sol",
    StlPreview_Desing2EntornoSunIntensityAria: "Intensidad de la luz direccional principal.",
    StlPreview_Desing2EntornoAmbientIntensityLabel: "Luz ambiental",
    StlPreview_Desing2EntornoAmbientIntensityAria: "Intensidad de la luz ambiental global.",
    StlPreview_Desing2EntornoIblIntensityLabel: "Reflejos ambiente (IBL)",
    StlPreview_Desing2EntornoIblIntensityAria: "Intensidad del mapa de entorno para materiales PBR.",
    StlPreview_Desing2EntornoExposureLabel: "Exposición",
    StlPreview_Desing2EntornoExposureAria: "Exposición de la cámara (tone mapping).",
    StlPreview_Desing2EntornoFogStrengthLabel: "Niebla atmosférica",
    StlPreview_Desing2EntornoFogStrengthAria: "Intensidad de la niebla de profundidad.",
    StlPreview_Desing2EntornoShadowQualityLabel: "Calidad de sombras",
    StlPreview_Desing2EntornoShadowQualityAria: "Resolución del mapa de sombras.",
    StlPreview_Desing2EntornoShadowsEnabledLabel: "Sombras en suelo y paneles",
    StlPreview_Desing2EntornoShadowsEnabledAria: "Activa o desactiva sombras proyectadas.",
    StlPreview_Desing2EntornoSiteFloorEnabledLabel: "Suelo de obra",
    StlPreview_Desing2EntornoSiteFloorEnabledAria: "Muestra un plano de suelo con textura de obra.",
    StlPreview_Desing2EntornoFogEnabledLabel: "Niebla",
    StlPreview_Desing2EntornoFogEnabledAria: "Activa o desactiva la niebla atmosférica.",
    StlPreview_Desing2EntornoSsaoEnabledLabel: "SSAO (contacto, más costoso)",
    StlPreview_Desing2EntornoSsaoEnabledAria: "Sombras de contacto en postprocesado; puede reducir FPS con muchos objetos.",
...
const en = Object.assign({}, es, {
  ...
  StlPreview_SaveWallsSavedToast: "Walls saved",
  StlPreview_SaveWallsNeedDesignToast: "Open a design to save walls",
  StlPreview_SaveWallsErrorToast: "Could not save walls",
  StlPreview_DesignSaving: "Saving design…",
  StlPreview_DesignLoading: "Loading design…",
  StlPreview_LeaveSaveTitle: "Leave design",
  StlPreview_LeaveSaveMessage: "Do you want to save the walls before leaving?",
  StlPreview_LeaveSaveYes: "Yes",
  StlPreview_LeaveSaveNo: "No",
  ...
  StlPreview_FormworkRenderingTitle: "Rendering {0} system",
  StlPreview_FormworkRenderingPhaseServer: "Calculating modules…",
  StlPreview_FormworkRenderingPhasePaint: "Painting panels…",
  StlPreview_FormworkRenderingRemainingSeconds: "About {0} s left",
  StlPreview_FormworkRenderingRemainingMinute: "About 1 min left",
  StlPreview_FormworkRenderingRemainingMinutes: "About {0} min left",
  StlPreview_FormworkRenderingAlmostDone: "Almost done…",
  ...
  StlPreview_Desing2EntornoLightingSectionTitle: "Formwork lighting",
  StlPreview_Desing2EntornoSunAzimuthLabel: "Sun azimuth",
  StlPreview_Desing2EntornoSunAzimuthAria: "Horizontal angle of the key light in degrees.",
  StlPreview_Desing2EntornoSunElevationLabel: "Sun elevation",
  StlPreview_Desing2EntornoSunElevationAria: "Elevation angle of the key light in degrees.",
  StlPreview_Desing2EntornoSunIntensityLabel: "Sun intensity",
  StlPreview_Desing2EntornoSunIntensityAria: "Intensity of the main directional light.",
  StlPreview_Desing2EntornoAmbientIntensityLabel: "Ambient light",
  StlPreview_Desing2EntornoAmbientIntensityAria: "Global ambient light intensity.",
  StlPreview_Desing2EntornoIblIntensityLabel: "Environment reflections (IBL)",
  StlPreview_Desing2EntornoIblIntensityAria: "Environment map intensity for PBR materials.",
  StlPreview_Desing2EntornoExposureLabel: "Exposure",
  StlPreview_Desing2EntornoExposureAria: "Camera exposure (tone mapping).",
  StlPreview_Desing2EntornoFogStrengthLabel: "Atmospheric fog",
  StlPreview_Desing2EntornoFogStrengthAria: "Depth fog intensity.",
  StlPreview_Desing2EntornoShadowQualityLabel: "Shadow quality",
  StlPreview_Desing2EntornoShadowQualityAria: "Shadow map resolution.",
  StlPreview_Desing2EntornoShadowsEnabledLabel: "Ground and panel shadows",
  StlPreview_Desing2EntornoShadowsEnabledAria: "Enable or disable cast shadows.",
  StlPreview_Desing2EntornoSiteFloorEnabledLabel: "Site floor",
  StlPreview_Desing2EntornoSiteFloorEnabledAria: "Show a textured construction-site ground plane.",
  StlPreview_Desing2EntornoFogEnabledLabel: "Fog",
  StlPreview_Desing2EntornoFogEnabledAria: "Enable or disable atmospheric fog.",
  StlPreview_Desing2EntornoSsaoEnabledLabel: "SSAO (contact, heavier)",
  StlPreview_Desing2EntornoSsaoEnabledAria: "Contact shadows in post-processing; may reduce FPS with many objects.",
